  ...
  return (
    <section id="home" className="relative h-screen w-full flex items-center justify-center overflow-hidden bg-transparent">
      ...
      */}
      ...
      <motion.div 
        style={{ opacity }}
        className="absolute bottom-12 left-1/2 -translate-x-1/2 flex flex-col items-center gap-4 z-10 cursor-pointer pointer-events-auto"
      ...
      >
        ...
        <div className="w-px h-16 bg-white/20 relative overflow-hidden mix-blend-difference">
          <motion.div 
