  ...
  return (
    <footer id="contact" className="relative border-t border-black/5 bg-white/80 backdrop-blur-xl px-6 py-20 md:px-12 md:py-32 z-10 w-full text-black">
      <div className="mx-auto max-w-7xl">
        ...
        {/* Bottom Bar */}
        <div className="mt-20 flex flex-col items-center justify-between gap-6 border-t border-black/5 pt-8 md:flex-row text-[10px] uppercase tracking-widest font-bold text-slate-400">
          <p>© {new Date().getFullYear()} Abhi Kansara. Visual Artist.</p>
          <div className="order-2 flex gap-8 md:order-2">
            ...
            <a href="https://virajmavani.dev" target="_blank" className="hover:text-black transition-colors group">
              Built by <span className="text-slate-500 group-hover:text-black transition-colors">Viraj Mavani</span>
            </a>
          </div>
        </div>
      </div>
